...
extension ContactLensesViewController: ARSCNViewDelegate {
    func renderer(_ renderer: SCNSceneRenderer, nodeFor anchor: ARAnchor) -> SCNNode? {
        ...
        let irisImage = #imageLiteral(resourceName: "bicolor_iris")
        /// Create eye ImageNodes
        rightEyeNode = ImageNode(width: 0.015, height: 0.015, image: irisImage)
        leftEyeNode = ImageNode(width: 0.015, height: 0.015, image: irisImage)
